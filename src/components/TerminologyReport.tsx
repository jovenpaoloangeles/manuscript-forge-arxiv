...
interface TerminologyReportProps {
  data: TerminologyData;
}

export const TerminologyReport = ({ data }: TerminologyReportProps) => {
  ...
  return (
    <Card className="shadow-academic">
      ...
      <CardContent className="space-y-6">
        <div>
          <h4 className="font-medium text-academic-text mb-3">Terminology Assessment</h4>
