...
interface ArgumentStrengthData {
  score: number;
  feedback: string;
  strengths: string[];
  suggestions: string[];
...
interface ArgumentStrengthReportProps {
  data: ArgumentStrengthData;
}

export const ArgumentStrengthReport = ({ data }: ArgumentStrengthReportProps) => {
  ...
  return (
    <Card className="shadow-academic">
      ...
      <CardContent className="space-y-6">
        <div>
          <h4 className="font-medium text-academic-text mb-3">Overall Assessment</h4>
